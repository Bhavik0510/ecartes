...
class EInvoicing(models.Model):
    ...
    eway_url_staging = fields.Char("Eway URL(Staging)", tracking=True,
    ...
    print_url_live = fields.Char("Eway Print URL(Live)", tracking=True,
    ...
    def handle_einvoicing_auth_token(self):
        ...
        _logger.info("Auth Response======%s", res)
